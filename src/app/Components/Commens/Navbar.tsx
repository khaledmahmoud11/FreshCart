      ...
      <nav className='bg-gray-100 p-5 sticky top-0 w-full z-50 gap-3'>
        <div className="container mx-auto flex items-center justify-between">
          ...
          <div className="nav-icons flex items-center gap-7">
            ...
            <>
              <Link href="/login" className='text-white text-md bg-green-600 hover:bg-green-800 rounded-3xl px-4 py-3 items-center justify-center gap-2 font-bold hidden lg:flex '> <UserRound size={16} /> Sign In</Link>          
            </> 
            :
            <>
              <DropdownMenu >
